...
$("#support_fund").click(function(){
        ...
        var id_name = id_amount = want_to_contribute_amount = id_pan_num = id_address = id_pincode  = id_amount = id_city = id_state = reg_number = trem_check = 0;
...
$("#upload_documents").click(function(){
   ...
   var _validFileExtensions_doc_upload = [".jpeg", ".jpg",".png"];    
       ...
       if (oInputimg.type == "file") {
           ...
           if (sFileName.length > 0) {
               ...
               if (!blnValid) {
                ...
                $("#id_address_proof_picture_error").text("Allowed file format : (png/jpeg/jpg)");
